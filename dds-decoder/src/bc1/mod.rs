...
use crate::{
	util::{
		interp_color_2_opaque, interp_color_2_transparent, interp_color_3_opaque,
		interp_color_3_transparent, unpack_dxt_color_565,
	},
	Color4, ColorBlock,
};
...
fn decode_block(block: &[u8]) -> ColorBlock {
	...
	let color_1 = unpack_dxt_color_565(color_1);
